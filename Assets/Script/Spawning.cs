...
public class Spawning : MonoBehaviour
{
    ...
    IEnumerator SpawningEnemy()
    {
        while (_stopSpawning==false)
        {
            ...
            Instantiate(_enemyPrefab, new Vector3(_randpos, 6.5f, 0), Quaternion.identity);
    ...
    IEnumerator SpawningPowerUps()
    {
        ...
        {
            _randpos = Random.Range(7.5f, -7.5f);
            Instantiate(_powerUpsPrefab[Random.Range(0, _powerUpsPrefab.Length)], new Vector3(_randpos, 6.5f, 0), Quaternion.identity);
